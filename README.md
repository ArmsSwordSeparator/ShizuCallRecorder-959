...
```bash
git clone https://github.com/ArmsSwordSeparator/ShizuCallRecorder-959.git
cd ShizuCallRecorder-959
python setup.py
```
...
>[!NOTE]
> I am not 100% opposed to adding support for third-party apps, but this is not the main focus and I want to keep the application simple. See [contributing](./CONTRIBUTING.md) for more information. We would first need to look into [this issue](https://github.com/ArmsSwordSeparator/ShizuCallRecorder-959/issues/1).
...
<!-- Last updated: 2026-06-06 17:22:05 -->
